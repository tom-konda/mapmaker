...
class WinCont {
    ...
    menulist_make() {
        Object.keys(Conf.menu).forEach(key => {
            ...
            if (confkey.linkto.includes("html:")) {
                ...
                if (!confkey.linkto.includes("javascript:")) $("#temp_menu>a:first").attr("target", "_blank");
        ...
        return new Promise((resolve, reject) => {
            ...
            modal_select_ok.addEventListener('click', () => {
                ...
                alldata.forEach((val) => {
                    ...
                    let enable = sel_ids.includes(val.osmid) ? true : false;
    ...
    menu_make(menulist, domid) {
        ...
        Object.keys(menulist).forEach((key) => {
            ...
            if (confkey.linkto.includes("html:")) {
                ...
                alink.setAttribute("target", !confkey.linkto.includes("javascript:") ? "_blank" : "");
